...
const Button = (props) => {
  const style = {
    ...
    fontSize: props.fontSize
      ? props.fontSize
      : props.height
      ? Math.floor(props.height * 0.38).toString()
      : 16,
    ...
    >
      <Title
        css={css`
          margin: 0 20px;
          padding: 0;
          padding-left: ${style.isActive && style.shouldShowIcon
            ? "10"
            : "0"}px;
        ...
        {!style.state && (
          ...
          >
            <Textfit
              ...
              max={style.fontSize}
            >
              {props.disabledText ? props.disabledText : props.text}
            </Textfit>
          </div>
        )}
      </Title>
      {style.shouldShowIcon && (
        <div
          css={css`
            ...
            padding: 0;
            align-self: flex-end;
            display: ${style.isActive ? "inline" : "none"};
          `}
        >
          <Lottie
