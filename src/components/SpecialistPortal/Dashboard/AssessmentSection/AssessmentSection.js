...
export default function AssessmentSection(props) {
  ...
  const renderAssessments = assessments.map((assessm) => {
      ...
      <StyledCard key={assessm.id}>
        <div className="assessment-container">
          <div className="left">
            ...
            <h5>{user.role.charAt(0).toUpperCase() + user.role.slice(1)}</h5>
            <h5>
          ...
          <div className="right">
            ...
            assessment.explanation5 === "" ? null : (
              <>
                <h4>
                  Imagine you’re an advocate for this idea. Name up to 5 reasons
                  why you would be so ‘pro’ this idea
                </h4>
                <ol>
                ...
                <h4>
                  Imagine you’re an opponent of this idea. Name up to 5 reasons
                  why you would be so ‘against’ this idea:
                </h4>
                <ol>
                ...
                <p>
                  <strong>{assessment.whatDoYouExpectAsTimeImpact}/10</strong>
                  <br></br>
                ...
                <p>
                  <strong>{assessment.whatDoYouExpectAsMagnitude}/10</strong>
                  <br></br>
                  {assessment.explanation6}
                </p>
                <h4>
                  Why is this not yet out there? Why have people in this field
                  or that could be helped by it, not successfully created it
                  yet?
                </h4>
                ...
                <h4>Can you think of a way to make this idea even better?</h4>
                <p>{assessment.explanation9}</p>
                <h4>Do you want to champion this idea by giving it a star?</h4>
                <p>
